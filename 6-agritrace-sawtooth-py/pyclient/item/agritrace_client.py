...
# ------------------------------------------------------------------------------
'''
This AgriTraceClient class interfaces with Sawtooth through the REST API.
'''
...
class AgriTraceClient(object):
    '''Client agri trace class.

    This supports item_transfer and item_history functions.
    '''
