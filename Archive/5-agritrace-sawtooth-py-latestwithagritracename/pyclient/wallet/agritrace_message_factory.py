...
# ------------------------------------------------------------------------------
'''
This file is used for automated testing of the agritrace client.
'''

from sawtooth_processor_test.message_factory import MessageFactory

class AgriTraceMessageFactory(object):
    def __init__(self, signer=None):
        self._factory = MessageFactory(
            family_name="agritrace",
            family_version="1.0",
            namespace=MessageFactory.sha512("agritrace".encode("utf-8"))[0:6],
            signer=signer)
